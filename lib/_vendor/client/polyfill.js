...
if((f=String.prototype).trim==d){var h;h=/^\s+|\s+$/g;f.trim=function(){return this.replace(h,"")}}Date.now==d&&(Date.now=(new Date).getTime());"Array"!==Array.name&&(Array.name="Array",Object.name="Object",Date.name="Date");
})();
